...
export default class ExpenseForm extends React.Component {
    ...
    render() {
        return (
            ...
            />
            <textarea value={this.state.note} className="text-area" onChange={this.onNoteChange} placeholder="what did you spend on today?"></textarea>
            <div >
            <center><button className="button">Save Expense</button></center>
            </div>
            </form>
